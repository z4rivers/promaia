...
class McpClient:
    ...
    def format_tools_for_prompt(self, server_names: Optional[List[str]] = None, compact: bool = False) -> str:
        ...
        if prompt_sections:
            ...
            # URL/fetch guidance removed — was hardcoded for puppeteer which isn't
            # in the current stack. When a fetch MCP server is connected, its
            # capabilities will be described dynamically from the server's tool list.
